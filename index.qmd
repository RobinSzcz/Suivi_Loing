...
cat(paste0(
  "
<p><strong>Nombre d’antennes : ", nrow(sites_antennes), "</strong></p>

<ul id='liste-antennes'>
  <li><a href='#' style='color:#3D619DFF; text-decoration:none;'>", sites_antennes$antenne[1], "</a></li>
  <li><a href='#' style='color:#3D619DFF; text-decoration:none;'>", sites_antennes$antenne[2], "</a></li>
  <li><a href='#' style='color:#3D619DFF; text-decoration:none;'>", sites_antennes$antenne[3], "</a></li>
  <li><a href='#' style='color:#3D619DFF; text-decoration:none;'>", sites_antennes$antenne[4], "</a></li>
  <li><a href='#' style='color:#3D619DFF; text-decoration:none;'>", sites_antennes$antenne[5], "</a></li>
</ul>
