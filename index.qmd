...
<ul id='liste-antennes'>
  <li><a href='#' data-antenne='Ronce aval' style='text-decoration:none; color:#3D619DFF;'>Ronce aval</a></li>
  <li><a href='#' data-antenne='Ronce amont' style='text-decoration:none; color:#3D619DFF;'>Ronce amont</a></li>
  <li><a href='#' data-antenne='Milleron' style='text-decoration:none; color:#3D619DFF;'>Milleron</a></li>
  <li><a href='#' data-antenne='Dalot' style='text-decoration:none; color:#3D619DFF;'>Dalot</a></li>
  <li><a href='#' data-antenne='Lancière' style='text-decoration:none; color:#3D619DFF;'>Lancière</a></li>
</ul>
...
```{r}
sites_antennes <- read_delim("C:/Users/r0bin/OneDrive - Profish/Projets Profish/Profish FR/EPAGE Le Loing/data/quarto/sites_antennes.csv", 
...
leaflet(sites_antennes, options = leafletOptions(worldCopyJump = TRUE)) %>%
  ...
  htmlwidgets::onRender("
    function(el, x) {
      ...
      // clic sur la liste HTML
      document.querySelectorAll('#liste-antennes a').forEach(function(link){
